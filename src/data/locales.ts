...
const locales: LocaleData = {
  en: {
    ...
    "nft.sellNow": "List for Sale",
    "nft.rentOut": "List for Rent",
    "nft.cancelSale": "Cancel Sale",
    "nft.cancelRent": "Cancel Rent",
    "nft.returnRental": "Return Rental",
    "nft.addedToFavorites": "Added to favorites",
    "nft.removedFromFavorites": "Removed from favorites",
    "nft.paymentCurrency": "Payment Currency",
    "nft.paymentAddress": "Payment Address",
    "nft.rentalPeriod": "Rental Period",
    "nft.days": "days",
  ...
  zh: {
    ...
    "nft.cancelSale": "取消出售",
    "nft.cancelRent": "取消出租",
    "nft.returnRental": "归还租赁",
    "nft.addedToFavorites": "已添加到收藏",
    "nft.removedFromFavorites": "已从收藏中移除",
    "nft.paymentCurrency": "支付币种",
    "nft.paymentAddress": "支付地址",
    "nft.rentalPeriod": "租赁期限",
    "nft.days": "天",
